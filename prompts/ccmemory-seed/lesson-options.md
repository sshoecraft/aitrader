...
Volatility: buying when implied vol is already rich means you overpay — it raises the move you need just to break even and bleeds if IV merely contracts. Ask whether IV looks stretched or cheap versus its own recent history before committing. The sharpest case is a scheduled catalyst, especially earnings: IV inflates into the event and collapses right after (IV crush). Holding long premium across such an event is the BASE CASE for losing even when the underlying moves your way. A known event date is a reason for skepticism, not a free lottery ticket.

Liquidity governs whether the edge is real. Thin open interest and wide bid-ask spreads mean the market takes a cut on both entry and exit — slippage that swamps a good thesis. Before committing, judge whether you can trade the contract BOTH directions without moving price against yourself. The strike you can exit on your terms beats the one that looks theoretically better.
